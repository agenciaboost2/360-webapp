...
export default function CreativeSection({ items, userId, userName }) {
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", margin: "28px 0 16px" }}>
        <div>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: 21, margin: 0 }}>Contenido creativo</h2>
      ...
      <div className="card" style={{ overflowX: "auto" }}>
        {items.length === 0 ? (
          <div style={{ textAlign: "center", color: "var(--text-dim)", padding: 24 }}>Todavía no hay ideas cargadas.</div>
        ) : (
